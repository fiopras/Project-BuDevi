        ...
        <div class="row align-items-center py-4">
          <div class="col-lg-6 col-7">
            ...
            <div class="col-lg-7 col-md-10">
                ...
                <a href="{{ route('dashboardgames.create')}}" class="btn btn-success">Tambah Data</a>
              </div>
                ...
                <div class="col">
                    <div class="card bg-default shadow">
                        <div class="card-header bg-transparent border-0">
                            <h3 class="text-white mb-0">Table Match</h3>
                        </div>
                    ...
                    <tr>
                      ...
                      <th scope="col" class="text-white text-center">ID</th>
                          <th scope="col" class="text-white text-center">Lawan Tanding</th>
                          <th scope="col" class="text-white text-center">Negara</th>
                          <th scope="col" class="text-white text-center">Tanggal Tanding</th>
                          <th scope="col" class="text-white text-center">Liga</th>
                          <th scope="col" class="text-white text-center">Score</th>
                  ...
                  <tbody>
                    <tr>
                        ...
                        <td class="text-white text-left">
                          ...
                          <td class="text-center text-white">
                            <img src="{{ asset($gm->logo) }}" height="auto" width="70">
                      ...
                      <td class="text-center">
                        ...
                        <a href="{{ route('dashboardgames.edit',$gm->id) }}" class="btn btn-sm btn-success"><i class="fas fa-fw fa-edit"></i>Edit</a>
                                <form action="{{ route('dashboardgames.destroy',$gm->id) }}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
