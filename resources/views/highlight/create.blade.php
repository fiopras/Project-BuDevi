    ...
    <div class="row">
      <div class="col">
        <div class="card bg-default shadow">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('dashboardhighlight.store') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-lg-6">
                          ...
                          <div class="col-lg-6">
                            <div class="form-group">
                              ...
                              <input type="text" id="isi_highlight" name="isi_highlight" class="form-control @error('isi_highlight') is-invalid @enderror" placeholder="Masukan Isi Highlight" value="">
                              @error('isi_highlight')
                              <div class="invalid-feedback">{{ $message}}</div>
                              @enderror
                            </div>
                          ...
                          <div class="col-lg-12">
                            <div class="form-group">
                              ...
                              <input type="text" id="link_video" name="link_video" class="form-control @error('link_video') is-invalid @enderror" placeholder="Masukan Link Video" value="">
                              @error('link_video')
                              <div class="invalid-feedback">{{ $message}}</div>
                              @enderror
                            </div>
